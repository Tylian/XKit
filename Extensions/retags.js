...
XKit.extensions.retags = {
    ...
    clear_old_posts: function() {
        ...
        postIds.sort(function(id_one, id_two) {
            return id_two - id_one;
        });
    ...
    html_toggle: $('<label class="retags binary_switch">' +
