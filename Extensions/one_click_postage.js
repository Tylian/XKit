...
XKit.extensions.one_click_postage = new Object({
	...
	run: function() {
		...
		if (this.preferences.default_blog.value !== "") {
			XKit.extensions.one_click_postage.default_blog_id = this.preferences.default_blog.value;
		} else {
			XKit.extensions.one_click_postage.default_blog_id = m_blogs[0];
		}
		...
		if (this.preferences.show_blog_selector.value === true) {
			...
			if (this.preferences.show_reverse_ui.value === true) {
				m_blogselector_html = $(m_blogselector_html).insertBefore("#x1cpostage_reblog");
			} else {
				m_blogselector_html = $(m_blogselector_html).insertBefore("#x1cpostage_caption");
			}
			m_blogselector_html.val(XKit.extensions.one_click_postage.default_blog_id);
		}
